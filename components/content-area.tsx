...
/**
 * Renders the lesson material for the active topic/subtopic. The markdown comes
 * from the content seam (lib/content/lessons.ts); when a topic has no published
 * content this shows an empty state.
 */
export function ContentArea({ topic, meta, activeSubtopic, markdown }: ContentAreaProps) {
  return (
